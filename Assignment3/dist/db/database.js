    ...
    if (err) {
        ...
        db.run(`CREATE TABLE Comments (
            ...
            if (err) {
                ...
                let insert = "INSERT into Comments (comment, userId, postId, commentDate) VALUES ($comment, $userId, $postId, $commentDate)";
                db.all(insert, {
                    $comment: "this is the first comment that will be on the First Test Post",
                    $userId: "admin",
                    $postId: "0",
